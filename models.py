...
class BHClose15T0Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_15T_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<BHClose15T id={self.id}>"


class BHClose15T2Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_15T_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose15T4Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_15T_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose15T6Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_15T_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose1H0Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_1H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<BHClose1H id={self.id}>"


class BHClose1H2Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_1H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose1H4Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_1H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose1H6Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_1H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose4H0Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_4H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<BHClose4H id={self.id}>"


class BHClose4H2Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_4H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose4H4Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_4H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose4H6Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_4H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose1D0Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_1D_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<BHClose1D id={self.id}>"


class BHClose1D2Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_1D_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose1D4Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_1D_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class BHClose1D6Sl(BacktestStrategyBH, Base):
    __tablename__ = "bh_close_1D_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose15T0Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_15T_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<BHStatsClose15T id={self.id}>"


class BHStatsClose15T2Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_15T_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose15T4Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_15T_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose15T6Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_15T_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose1H0Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_1H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<BHStatsClose1H id={self.id}>"


class BHStatsClose1H2Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_1H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose1H4Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_1H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose1H6Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_1H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose4H0Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_4H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<BHStatsClose4H id={self.id}>"


class BHStatsClose4H2Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_4H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose4H4Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_4H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose4H6Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_4H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose1D0Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_1D_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<BHStatsClose1D id={self.id}>"


class BHStatsClose1D2Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_1D_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose1D4Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_1D_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class BHStatsClose1D6Sl(StatsStrategy, Base):
    __tablename__ = "BH_stats_close_1D_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TradeHistoryBH15T0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_15T_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH15T2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_15T_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH15T4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_15T_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH15T6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_15T_6_12".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH1H0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_1H_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH1H2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_1H_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH1H4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_1H_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH1H6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_1H_6_12".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH4H0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_4H_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH4H2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_4H_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH4H4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_4H_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH4H6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_4H_6_12".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH1D0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_1D_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH1D2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_1D_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH1D4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_1D_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryBH1D6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_bh_close_1D_6_12".lower()
    id = Column(Integer, primary_key=True)


# ----------------- STO ---------------------

class BacktestStrategySTO():
    ADVANC_datetime = Column(DATETIME(
        storage_format="%(year)04d-%(month)02d-%(day)02d" +
        "%(hour)02d:%(minute)02d:%(second)02d"),
        default=datetime.datetime.utcnow)
...
class STOClose15T0Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_15T_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<STOClose15T id={self.id}>"


class STOClose15T2Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_15T_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose15T4Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_15T_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose15T6Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_15T_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose1H0Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_1H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<STOClose1H id={self.id}>"


class STOClose1H2Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_1H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose1H4Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_1H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose1H6Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_1H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose4H0Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_4H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<STOClose4H id={self.id}>"


class STOClose4H2Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_4H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose4H4Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_4H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose4H6Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_4H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose1D0Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_1D_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<STOClose1D id={self.id}>"


class STOClose1D2Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_1D_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose1D4Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_1D_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class STOClose1D6Sl(BacktestStrategySTO, Base):
    __tablename__ = "sto_close_1D_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose15T0Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_15T_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<STOStatsClose15T id={self.id}>"


class STOStatsClose15T2Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_15T_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose15T4Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_15T_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose15T6Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_15T_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose1H0Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_1H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<STOStatsClose1H id={self.id}>"


class STOStatsClose1H2Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_1H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose1H4Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_1H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose1H6Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_1H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose4H0Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_4H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<STOStatsClose4H id={self.id}>"


class STOStatsClose4H2Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_4H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose4H4Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_4H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose4H6Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_4H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose1D0Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_1D_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<STOStatsClose1D id={self.id}>"


class STOStatsClose1D2Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_1D_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose1D4Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_1D_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class STOStatsClose1D6Sl(StatsStrategy, Base):
    __tablename__ = "STO_stats_close_1D_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TradeHistorySTO15T0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_15T_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO15T2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_15T_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO15T4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_15T_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO15T6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_15T_6_12".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO1H0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_1H_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO1H2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_1H_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO1H4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_1H_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO1H6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_1H_6_12".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO4H0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_4H_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO4H2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_4H_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO4H4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_4H_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO4H6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_4H_6_12".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO1D0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_1D_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO1D2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_1D_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO1D4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_1D_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistorySTO1D6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_sto_close_1D_6_12".lower()
    id = Column(Integer, primary_key=True)

# ------------ TSL ---------------


class BacktestStrategyTSL():
    ADVANC_datetime = Column(DATETIME(
        storage_format="%(year)04d-%(month)02d-%(day)02d" +
        "%(hour)02d:%(minute)02d:%(second)02d"),
        default=datetime.datetime.utcnow)
...
class TSLClose15T0Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_15T_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<TSLClose15T id={self.id}>"


class TSLClose15T2Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_15T_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose15T4Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_15T_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose15T6Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_15T_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose1H0Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_1H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<TSLClose1H id={self.id}>"


class TSLClose1H2Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_1H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose1H4Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_1H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose1H6Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_1H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose4H0Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_4H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<TSLClose4H id={self.id}>"


class TSLClose4H2Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_4H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose4H4Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_4H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose4H6Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_4H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose1D0Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_1D_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<TSLClose1D id={self.id}>"


class TSLClose1D2Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_1D_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose1D4Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_1D_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class TSLClose1D6Sl(BacktestStrategyTSL, Base):
    __tablename__ = "tsl_close_1D_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose15T0Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_15T_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<TSLStatsClose15T id={self.id}>"


class TSLStatsClose15T2Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_15T_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose15T4Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_15T_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose15T6Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_15T_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose1H0Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_1H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<TSLStatsClose1H id={self.id}>"


class TSLStatsClose1H2Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_1H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose1H4Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_1H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose1H6Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_1H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose4H0Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_4H_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<TSLStatsClose4H id={self.id}>"


class TSLStatsClose4H2Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_4H_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose4H4Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_4H_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose4H6Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_4H_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose1D0Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_1D_0_0".lower()
    id = Column(Integer, primary_key=True)

    def __repr__(self):
        return f"<TSLStatsClose1D id={self.id}>"


class TSLStatsClose1D2Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_1D_2_4".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose1D4Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_1D_4_8".lower()
    id = Column(Integer, primary_key=True)
...
class TSLStatsClose1D6Sl(StatsStrategy, Base):
    __tablename__ = "TSL_stats_close_1D_6_12".lower()
    id = Column(Integer, primary_key=True)
...
class TradeHistoryTSL15T0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_15T_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL15T2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_15T_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL15T4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_15T_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL15T6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_15T_6_12".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL1H0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_1H_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL1H2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_1H_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL1H4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_1H_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL1H6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_1H_6_12".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL4H0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_4H_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL4H2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_4H_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL4H4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_4H_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL4H6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_4H_6_12".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL1D0Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_1D_0_0".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL1D2Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_1D_2_4".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL1D4Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_1D_4_8".lower()
    id = Column(Integer, primary_key=True)


class TradeHistoryTSL1D6Sl(Base, TradeHistory):
    __tablename__ = "trade_history_tsl_close_1D_6_12".lower()
    id = Column(Integer, primary_key=True)
